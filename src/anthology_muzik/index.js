...
function parseChannels(content) {
    ...
    for (var i = 0; i < lines.length; i++) {
        ...
        if (line.indexOf('#EXTINF') !== -1) {
            ...
            if (group.indexOf('MÜZİK') !== -1 || group.indexOf('EĞLENCE') !== -1) {
        ...
        .then(function(content) {
            ...
            var metas = channels.map(function(ch) {
                return {
                    ...
                    poster: ch.logo,
                    background: ch.logo,
                    genres: ["Müzik & Eğlence"],
                    description: ch.name + " Canlı Müzik Yayını"
                };
            });
            return { metas: metas };
        })
        ...
        .then(function(content) {
            ...
            return {
                meta: {
                    ...
                    poster: ch.logo,
                    background: ch.logo,
                    description: ch.name + " Canlı Müzik & Eğlence Yayını",
                    genres: ["Müzik & Eğlence"],
