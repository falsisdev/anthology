 ...
 * Build Date: 2026-09-20T20:49:56.200Z
 */
...
function parseChannels(content) {
  ...
  for (var i = 0; i < lines.length; i++) {
    ...
    if (line.indexOf("#EXTINF") !== -1) {
      ...
      if (group.indexOf("M\xDCZ\u0130K") !== -1 || group.indexOf("E\u011ELENCE") !== -1) {
  ...
  return fetchChannels().then(function(content) {
    ...
    var metas = channels.map(function(ch) {
      return {
        ...
        poster: ch.logo,
        background: ch.logo,
        genres: ["M\xFCzik & E\u011Flence"],
        description: ch.name + " Canl\u0131 M\xFCzik Yay\u0131n\u0131"
      };
    });
    return { metas };
  }).catch(function() {
  ...
  return fetchChannels().then(function(content) {
    ...
    return {
      meta: {
        ...
        poster: ch.logo,
        background: ch.logo,
        description: ch.name + " Canl\u0131 M\xFCzik & E\u011Flence Yay\u0131n\u0131",
        genres: ["M\xFCzik & E\u011Flence"],
