/**
 * Anthology - Sinezy Provider
 * Film ve Dizi destekler
 */

var BASE_URL = 'https://sinezy.org';
...
async function getStreams(tmdbId, mediaType, seasonNum, episodeNum) {
  ...
  try {
    ...
    for (const slug of slugs) {
      const targetUrl = isTV ? `${BASE_URL}/dizi/${slug}/${s}-sezon-${e}-bolum/` : `${BASE_URL}/${slug}-izle/`;
      try {
