 ...
 * Build Date: 2026-09-19T21:03:10.740Z
 */
...
function cfgReady() {
  if (!_cfgReady) {
    _cfgReady = loadConfig().then(function() {
      var v;
      v = val("urls.series.diziyou.base");
      if (v) BASE_URL = String(v).replace(/\/+$/, "");
      v = val("urls.series.diziyou.storage");
      if (v) STORAGE_URL = String(v).replace(/\/+$/, "");
